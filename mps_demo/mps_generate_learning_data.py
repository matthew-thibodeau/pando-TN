...
for run_id in range(runs):
    ...
    succ = dmrg.solve(energy_tol, max_sweeps = 300, sweep_sequence = 'RL', verbosity = 1)
    ...
    if succ:
        ...
        print('successfully diagonalized H!')
        ...
        filename = '/projects/physics/mt24/pando/mps_data/learning_data/cos_random/run_data_' + this_id
        np.save(filename, run_data)
        
    else:
        print('failed to diagonalize H')
